<template>
  <v-app id="inspire" :style="{background: $vuetify.theme.themes.dark.background}">
    <v-container v-if="$store.state.token==='token'">
      <v-row>
        <v-col cols="12" sm="12">
          <v-card
          ...
          >
            <v-row>
                        ...
                        <v-list-item-content>
                          <div class="mb-4">
                            <v-btn tile fab color="orange" elevation="0">
                              <v-icon color="">fas fa-cart-arrow-down</v-icon>
                            </v-btn>
                          </div>
                          <v-list-item-title class="headline mb-1 white--text">
                            120
                          </v-list-item-title>
                          <v-list-item-subtitle class="white--text">45% </v-list-item-subtitle>
                        </v-list-item-content>
                      </v-list-item>
                    </v-col>
                    <v-col cols="12" sm="4">
                        ...
                        <v-list-item-content>
                          <div class="mb-4">
                            <v-btn tile fab color="#6e0b14" elevation="0">
                              <v-icon color="">	fas fa-dollar-sign</v-icon>
                            </v-btn>
                          </div>
                          <v-list-item-title class="headline mb-1 white--text">
                            600
              ...
              <v-col cols="12" sm="8">
                ...
                <v-toolbar flat color="rgba(0,0,0,0)" dark>
                  <v-toolbar-title>Savdoning umumiy ko'rinishi</v-toolbar-title>
                  <v-spacer></v-spacer>
                ...
                <v-toolbar flat color="rgba(0,0,0,0)" dark>
                  <v-toolbar-title>Valyutaning ayni vaqtdagi qiymati</v-toolbar-title>
                </v-toolbar>
                <v-row>
                  <v-col cols="12" sm="2">
                  ...
                  <v-col cols="12" sm="2"><span class="white--text">Dollor</span></v-col>
                  <v-col cols="12" sm="2"><span class="white--text">10:42:23 AM</span></v-col>
                  <v-col cols="12" sm="2"><span class="white--text">+1235,00 so'm</span></v-col>
